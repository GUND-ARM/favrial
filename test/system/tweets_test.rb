...
class TweetsTest < ApplicationSystemTestCase
  ...
  test "should create tweet" do
    ...
    fill_in "Classification", with: @tweet.classification
    check "Classified" if @tweet.classified
    fill_in "Raw json", with: @tweet.raw_json
    fill_in "T", with: @tweet.t_id
    fill_in "Type", with: @tweet.type
